...
int makeTruth_dist(const std::string configfile = "binning.config", const int cone_size = 3)
{
  ...
  std::string j10_file = rb.get_tntuple_location() + "/TREE_MATCH_CALIB_SMEAR_r0" +std::to_string(cone_size) + "_v6_10_new_ProdA_2024-00000021.root";
  std::string j20_file = rb.get_tntuple_location() + "/TREE_MATCH_CALIB_SMEAR_r0" +std::to_string(cone_size) + "_v6_20_new_ProdA_2024-00000021.root";
  std::string j30_file = rb.get_tntuple_location() + "/TREE_MATCH_CALIB_SMEAR_r0" +std::to_string(cone_size) + "_v6_30_new_ProdA_2024-00000021.root";
